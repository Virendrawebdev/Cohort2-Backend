    ...
    return (
        <>
            ...
            >
                ...
                {/* ── RIGHT: Form Panel ── */}
                <div
                    className="w-full lg:w-1/2 flex items-center justify-center h-screen px-8 sm:px-14 lg:px-20 py-16 overflow-y-auto"
                ...
                >
                    <div className="w-screen max-w-sm">
                        ...
                        <div className="mb-10">
                            ...
                            <h1
                                className="text-[2.2rem] xl:text-5xl font-light leading-[1.1]"

...
const Register = () => {
    ...
    return (
        <div className="h-screen bg-[#0e0e0e] text-[#e5e2e1] font-sans selection:bg-[#FFD700] selection:text-[#131313] flex flex-col md:flex-row">

            {/* Split Screen - Left Image Section (Hidden on mobile, visible on md screens and up) */}
            <div className="hidden md:flex w-1/2 relative bg-[#131313] items-center justify-center overflow-hidden border-r border-[#1c1b1b]">
                <img
            ...
            <div className="w-screen md:w-1/2 flex items-center justify-center p-4 sm:p-6 md:p-8 lg:p-16 flex-1 z-10 bg-[#0e0e0e]">
                <div className="w-full max-w-sm sm:max-w-md bg-[#131313] md:bg-transparent lg:bg-transparent p-6 sm:p-8 md:p-10 lg:p-6 rounded-2xl md:rounded-none lg:rounded-none shadow-[0_24px_48px_-12px_rgba(0,0,0,0.5)] md:shadow-none lg:shadow-none">
                    ...
                    <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                        ...
                        <div className="flex flex-col">
                            ...
                            <input
                                ...
                                required
                                className="bg-[#1c1b1b] md:bg-[#0e0e0e] lg:bg-[#0e0e0e] text-white border-b-2 border-[#4d4732] focus:border-[#FFD700] outline-none px-4 py-3 transition-colors duration-300 focus:bg-[#201f1f] md:focus:bg-[#131313] lg:focus:bg-[#131313]"

...
export const listFiles = tool(
    async ({ }) => {
        ...
        const response = await axios.get("http://019e3ab4-df2e-745c-8ed3-9fdfa8b75bd7.agent.localhost/list-files")
...
export const readFiles = tool(
    async ({ files: [] }) => {
        ...
        const response = await axios.get("http://019e3ab4-df2e-745c-8ed3-9fdfa8b75bd7.agent.localhost/read-files?files=" + files.join(","))
...
export const updateFiles = tool(
    async ({ files }) => {
        ...
        const response = await axios.patch("http://019e3ab4-df2e-745c-8ed3-9fdfa8b75bd7.agent.localhost/update-files", {
            updates: files
        })
        console.log("=================================")
